    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;margin:auto;background:#fff;border-radius:12px;box-shadow:0 2px 8px rgba(0,0,0,0.07);overflow:hidden;">
      <tr>
        <td style="background:#0e1a2b;padding:32px 0;text-align:center;">
          ...
          <h1 style="color:#fff;font-size:2rem;margin:0;letter-spacing:2px;">Evangelism Discipleship Mission</h1>
        </td>
      </tr>
      <tr>
        <td style="padding:40px 32px 32px 32px;">
          <h2 style="color:#0e1a2b;font-size:1.5rem;margin-bottom:12px;">Verify your email address</h2>
          <p style="color:#333;font-size:1rem;line-height:1.6;margin-bottom:24px;">Hi <b>${name}</b>,<br><br>Thank you for joining <b>Evangelism Discipleship Mission</b>! Please confirm your email address to activate your account and get started.<br><br><span style='color:#0e1a2b;font-weight:bold;'>Why verify?</span> Verifying your email helps us keep your account secure and ensures you receive important updates and opportunities from our mission community.</p>
      ...
      <tr>
        <td style="background:#f6f8fa;padding:24px 0;text-align:center;color:#aaa;font-size:0.9rem;">&copy; ${new Date().getFullYear()} Evangelism Discipleship Mission. All rights reserved.</td>
      </tr>
    </table>
  </div>
  `;
