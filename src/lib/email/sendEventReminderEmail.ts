              ...
              <table width="600" cellpadding="0" cellspacing="0" style="background: #fff; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.06); overflow: hidden;">
                <tr>
                  <td style="background: #003366; padding: 32px 0; text-align: center;">
                    ...
                    <h1 style="color: #fff; font-size: 2rem; margin: 0; font-weight: 700; letter-spacing: 1px;">Event Reminder</h1>
                  </td>
                </tr>
                <tr>
                  <td style="padding: 32px 40px 24px 40px;">
                    <p style="font-size: 1.1rem; color: #222; margin-bottom: 18px;">Hi <strong>${name}</strong>,</p>
                    <p style="font-size: 1.05rem; color: #333; margin-bottom: 18px;">This is a reminder for <strong>${event.title}</strong>!</p>
                    <table style="margin: 24px 0 32px 0; width: 100%; background: #f0f4f8; border-radius: 8px;">
                      ...
                      ${event.isVirtual === 'true' || event.isVirtual === true ? `<tr><td style="padding: 12px 18px; font-size: 1rem; color: #0077cc;"><strong>Online Event Link:</strong> <a href="${event.onlineLink}" style="color:#0077cc; text-decoration:underline;">${event.onlineLink}</a></td></tr>` : `<tr><td style="padding: 12px 18px; font-size: 1rem; color: #003366;"><strong>Location:</strong> ${event.location}</td></tr>`}
                    </table>
