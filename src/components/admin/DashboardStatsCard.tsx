...
const DashboardStatsCard: React.FC<DashboardStatsCardProps> = ({ value, label, icon, color, className }) => (
  <div className={`flex flex-col items-center justify-center bg-gradient-to-br from-gray-800 via-gray-900 to-gray-700 rounded-xl shadow-lg p-4 sm:p-6 min-w-[160px] min-h-[100px] border border-gray-700 text-center w-full ${color ? color : ''} ${typeof className === 'string' ? className : ''}`}>
