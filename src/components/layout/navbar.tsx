                ...
                <ScrollArea className="h-[calc(100vh-var(--header-height,120px))]"> {/* Adjusted height */}
                  <nav className="flex flex-col p-4 space-y-2">
                    ...
                    {loading ? (
                      ...
                      <>
                        <SheetClose asChild>
                          <Link href="/dashboard" className="flex items-center rounded-md py-2 px-3 text-sm font-medium hover:bg-accent text-foreground hover:text-accent-foreground">
                            <LayoutDashboard className="mr-2 h-4 w-4 text-primary" /> Dashboard
                          </Link>
                        </SheetClose>
                         <SheetClose asChild>
                          <Link href="/dashboard/profile" className="flex items-center rounded-md py-2 px-3 text-sm font-medium hover:bg-accent text-foreground hover:text-accent-foreground">
                      ...
                      <>
                        <SheetClose asChild>
                          <Link href="/auth/login" className="flex items-center rounded-md py-2 px-3 text-sm font-medium hover:bg-accent text-foreground hover:text-accent-foreground">
                            <LogIn className="mr-2 h-4 w-4 text-primary" /> Sign In
                          </Link>
                        </SheetClose>
                        <SheetClose asChild>
                          <Link href="/auth/signup" className="flex items-center rounded-md py-2 px-3 text-sm font-medium hover:bg-accent text-foreground hover:text-accent-foreground">
