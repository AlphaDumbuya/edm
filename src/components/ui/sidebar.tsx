  ...
  (
    ...
    if (collapsible === "none") {
      return (
        <div
          className={cn(
            "flex 100vh w-[--sidebar-width] flex-col bg-sidebar text-sidebar-foreground",
            className
          )}
          ref={ref}
          {...props}
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "duration-200 fixed inset-y-0 z-10 hidden 100vh w-[--sidebar-width] transition-[left,right,width] ease-linear md:flex",
            side === "left"
