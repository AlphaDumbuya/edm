...
import { Send, User, Briefcase, CalendarDays, PhoneIcon, MailIcon, Brain } from 'lucide-react';
    ...
    <Card className="w-full shadow-xl border-primary/20">
      ...
      <form onSubmit={form.handleSubmit(onSubmit)}>
        <CardContent className="space-y-4">
          ...
          <div className="space-y-1.5">
            <Label className="flex items-center"><Briefcase className="mr-2 h-4 w-4"/> Areas of Interest (Select all that apply)</Label>
            ...
            {form.formState.errors.areasOfInterest && <p className="text-sm text-destructive mt-1">{form.formState.errors.areasOfInterest.message}</p>}
          </div>
...
import { FormField as RHFFormField, FormItem as RHFFormItem, FormLabel as RHFFormLabel, FormControl as RHFFormControl, FormMessage as RHFFormMessage } from "@/components/ui/form"

const FormField = RHFFormField
const FormItem = RHFFormItem
const FormLabel = RHFFormLabel
const FormControl = RHFFormControl
const FormMessage = RHFFormMessage
