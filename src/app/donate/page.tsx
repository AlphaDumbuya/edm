      ...
      <section id="more-support-options" className="bg-card p-8 md:p-12 rounded-lg shadow-lg">
        ...
        <div className="grid md:grid-cols-2 gap-x-12 gap-y-8 items-start">
          ...
          <div className="space-y-8">
            <h3 className="text-2xl font-semibold text-foreground border-b pb-2">Direct Giving</h3>
            <div>
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <p className="text-muted-foreground mb-4">
                Your collaboration can amplify our impact. We offer various ways for individuals, churches, and organizations to partner with us in fulfilling the Great Commission. Discover how you can join forces with EDM.
              </p>
