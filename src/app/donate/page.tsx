    ...
    <div className="space-y-12">
      ...
      <section className="text-center">
        ...
        <div className="max-w-3xl mx-auto text-lg text-muted-foreground space-y-4">
          <p>
            At EDM Connect, we rely on the faithful support of partners like you to carry out our work of evangelism, discipleship, and missions. Your donations enable us to send missionaries, provide resources, run community programs, and bring hope to those in need.
          </p>
          <p>
      ...
      <section id="mail-details" className="bg-card p-8 md:p-12 rounded-lg shadow-lg">
        ...
        <div className="space-y-2 text-foreground">
          ...
          <p>EDM Connect<br />123 Mission Lane<br />Faith City, FC 54321</p>
          <p className="mt-4"><strong>For other inquiries, please contact our finance department:</strong></p>
          <p>Email: finance@edmconnect.org</p>
      ...
      <section className="text-center">
        <p className="text-muted-foreground mb-4">
          EDM Connect is a registered non-profit organization. All donations are tax-deductible to the extent allowed by law.
        </p>
