  ...
  const articles = {
    'urgency-great-commission': {
      ...
      content: `
        ...
        <p class="mb-4 text-lg text-muted-foreground">Every believer involved with EDM, whether in Sierra Leone or through our Ohio partnerships, has a role. This includes direct evangelism, robust discipleship programs that train individuals to maturity, and mission projects that serve practical needs while opening doors for the Gospel. The urgency compels us to active participation, not complacency. Our vision for a campus with a Bible school, retreat center, and more, is all geared towards more effectively fulfilling this commission.</p>
    ...
    'effective-discipleship': { // Added a new slug for the second article
      ...
      content: `
        ...
        <figure class="my-6">
          <img src="https://placehold.co/700x350.png" alt="Mentorship session connecting Sierra Leone and Ohio" class="rounded-lg shadow-md mx-auto" data-ai-hint="mentor teaching online"/>
        ...
        <p class="mb-4 text-lg text-muted-foreground">Our Ohio partners contribute significantly by providing resources, prayer support, and sometimes even expertise that complements our on-the-ground efforts in Sierra Leone. This transatlantic collaboration allows for a richer exchange of ideas and a broader support network for our discipleship initiatives.</p>
