...
const involvementOpportunities = [
	{
		...
		icon: Users,
		description:
			'Offer your talents to support EDM\'s work in Sierra Leone or assist our Oregon-based partners with administrative, technical, or outreach tasks.',
		link: '/get-involved/volunteer',
		imageUrl:
			'https://plus.unsplash.com/premium_photo-1681195079271-cbfd9ba1cbc7?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTE3fHx2b2x1bnRlZXJ8ZW58MHx8MHx8fDA%3D',
	...
	},
	{
		...
		icon: HeartHandshake,
		description:
			'Commit to praying regularly for our missionaries, projects, the communities we serve in Sierra Leone, and our partnerships in Oregon.',
		link: '/get-involved/prayer',
		imageUrl:
			'https://plus.unsplash.com/premium_photo-1725408009157-3e89fa57f253?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NDN8fGJsYWNrJTIwcGVvcGxlJTIwcHJheWluZ3xlbnwwfHwwfHx8MA%3D%3D',
	...
	},
	{
		...
		icon: PartnerIcon,
		description:
			'Explore how your church, organization, or business can formally partner with EDM to amplify our impact in Sierra Leone and Oregon.',
		link: '/get-involved/partner',
		imageUrl:
			'https://media.istockphoto.com/id/96653688/photo/handshake.webp?a=1&b=1&s=612x612&w=0&k=20&c=2o15a4X4zTScv56ipJaem6iV5jcNqnu-n3IRm8Eys-o=',
	...
	},
	{
		...
		icon: Film,
		description:
			'Organize a showing of the "Jesus" film or an EDM awareness event in your community to share our mission and gather support.',
		link: '/get-involved/movie-screening',
		imageUrl:
			'https://images.unsplash.com/photo-1703764884882-2edc8c4961bc?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTR8fGplc3VzJTIwbW92aWUlMjBzaG93JTIwaW4lMjBhZnJpY2F8ZW58MHx8MHx8fDA%3D',
