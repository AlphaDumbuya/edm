...
export default function BibleSchoolPage() {
  return (
    <div className="space-y-12 min-h-screen">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {/* Samuel Tarawally */}
        <Card className="flex flex-col items-center text-center p-6 shadow-lg bg-card text-card-foreground">
        ...
        <Card className="flex flex-col items-center text-center p-6 shadow-lg bg-card text-card-foreground">
          ...
          <CardContent>
            <CardTitle className="text-xl">Melvin Tina Kamara</CardTitle>
